data "template_file" "searchbroker_service" {
  ...
  vars = {
    ...
    auth_host         = format("https://auth.%s.germanbiobanknode.de", terraform.workspace)
...
data "template_file" "searchbroker_ui_service" {
  ...
  vars = {
    ...
    auth_host       = format("https://auth.%s.germanbiobanknode.de", terraform.workspace)
    auth_public_key = ""
    mdr_api_url     = format("https://mdr.%s.germanbiobanknode.de/v3/api/mdr", terraform.workspace)
    mdr_namespace   = "mdr16"
    mdr_language    = "en"
