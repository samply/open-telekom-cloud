data "template_file" "searchbroker_service" {
  ...
  vars = {
    ...
    auth_host         = terraform.workspace == "default" ? "https://auth.germanbiobanknode.de" : "https://auth.dev.germanbiobanknode.de"
...
data "template_file" "searchbroker_ui_service" {
  ...
  vars = {
    ...
    auth_host       = terraform.workspace == "default" ? "https://auth.germanbiobanknode.de" : "https://auth.dev.germanbiobanknode.de"
    auth_public_key = ""
    mdr_api_url     = terraform.workspace == "default" ? "https://mdr.germanbiobanknode.de/v3/api/mdr" : "https://mdr.dev.germanbiobanknode.de/v3/api/mdr"
    mdr_namespace   = "mdr16"
    mdr_language    = "en"
